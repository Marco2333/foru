...
<html>
	<head>
		...
		<script type="text/javascript" src="/foryou/Public/script/login.js"></script>
	...
	<body>
		<div class="wrapper">
			...
			<div id="login-main">
				<div class="fl">
					<img src="/foryou/Public/img/login-show.png" />
					<div>为你，为更好地生活</div>
				</div>
				<div class="fr">
					<h1>For优会员</h1>
					...
					<div id="security-code">
						...
						<span id="security-code-img"><img src=" /foryou/index.php/Home/Login/verify/id/'+Math.random()" onclick="this.src='/foryou/index.php/Home/Login/verify/id/'+Math.random()"/> </span><!-- <span><a >看不清，换一张</a> </span> -->
					</div>
