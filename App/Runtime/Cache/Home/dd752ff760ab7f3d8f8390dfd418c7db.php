...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<ul class="nav nav-pills">
			...
			<div id="nav-breadcrumb" class="wrapper">
				<ul class="breadcrumb">
					...
					<li class="active">
						<a href="/index.php/Home/Person/orderManage/campusId/1/status/5.html">
							<?php
						    ...
						    <?php elseif($page["together_id"] !== $currentId): ?> 
						    	...
						    	<tbody>	
									...
									<tr class="order-info-detailed" data-status="<?php echo ($page['order_id']); ?>">
										...
										<td>
											<?php
 switch($page['status']) { case 1:echo "待付款";break; case 2:echo "待确认";break; case 3:echo "配送中";break; case 4:echo "待评价";break; case 5:echo "已完成";break; case 9:echo "退款中";break; case 10:echo "退款中";break; case 11:echo "退款完成";break; default:echo ""; } ?>
										</td>
										<td class='font-13'>
											￥<?php echo ($page["Price"]); ?>
										</td >
 ...
 switch($page['status']) { case 1: echo '<button class="order-manage-button order-manage-3 per-order-manage">
	...
	<div id="foot-part4" class="clearfix text-light">
		...
		<script type="text/javascript" src="/Public/script/ordermanage.js"></script>
